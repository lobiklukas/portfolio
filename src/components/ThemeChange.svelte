<script>
	...
	export let btnClasses = 'btn-outline btn-secondary';
...
<div title="Change Theme" class={`dropdown dropdown-end ${dropdownClasses}`}>
	...
	<div
		class={`dropdown-content bg-base-200 text-base-content rounded-t-box rounded-b-box top-px max-h-96 h-[70vh] w-52 overflow-y-auto shadow-4xl ${contentClasses}`}
	>
